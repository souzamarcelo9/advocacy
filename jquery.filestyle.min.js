...
(function ($) {
    ...
    JFilestyle.prototype = {
        ...
        htmlInput: function () {
            if (this.options.input) {
                return '<input class="form-control" type="text" style="width:'+this.options.inputSize+'" placeholder="'+ this.options.placeholder +'" disabled> ';
            } else {
                return '';
            }
        },
        ...
        constructor: function () {
            ...
            html = '<span class=" input-group-btn">'+
                     '<label class="btn btn-success-cadastro btn-lg" for="'+id+'" ' + (_self.options.disabled ? 'disabled="true"' : '') + '>'+
            ...
            _self.$elementjFilestyle = $('<div class="input-group jfilestyle ' + (_self.options.input?'jfilestyle-corner':'') + ' ' + (this.options.buttonBefore ? ' jfilestyle-buttonbefore' : '') + '">'+html+'</div>');
